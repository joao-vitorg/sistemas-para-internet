package abstrato.biblioteca;

import java.util.Date;

public class Main {
	public static void main(String[] args) {
		Usuario usuario1 = new Usuario("João", "João@gmail.com", "123");
		Usuario usuario2 = new Usuario("vitor", "vitor@gmail.com", "456");
		Usuario usuario3 = new Usuario("gomes", "gomes@gmail.com", "789");
