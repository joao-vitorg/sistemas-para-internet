package com.example.notification.notification.models;
...
public class NotificationMessage implements Serializable {
    ...
    public String toString() {
        return "NotificationMessage{" + "recipientToken='" + recipientToken + '\'' + ", title='" + title + '\'' + ", body='" + body + '\'' + ", image='" + image + '\'' + ", data=" + data + '}';
    }
}
